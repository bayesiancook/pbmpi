...
#ifndef PARTEXPCONGTRMIXTUREPROFILE_H
#define PARTEXPCONGTRMIXTUREPROFILE_H
...
class PartitionedExpoConjugateGTRMixtureProfileProcess : public virtual PartitionedGTRMixtureProfileProcess, public virtual PartitionedExpoConjugateGTRProfileProcess {

	public:

	PartitionedExpoConjugateGTRMixtureProfileProcess() : profilesuffstatcount(0), profilesuffstatbeta(0) {}
	virtual ~PartitionedExpoConjugateGTRMixtureProfileProcess() {}
