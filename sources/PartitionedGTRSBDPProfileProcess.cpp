...
void PartitionedGTRSBDPProfileProcess::SwapComponents(int cat1, int cat2)	{

	SBDPProfileProcess::SwapComponents(cat1,cat2);
	for(size_t p = 0; p < GetNpart(); p++)
	{
		UpdateMatrix(p, cat1);
		UpdateMatrix(p, cat2);
	}
...
double PartitionedGTRSBDPProfileProcess::GlobalMixMove(int nrep, int nallocrep, double epsilon, int nprofilerep)	{
...
void PartitionedGTRSBDPProfileProcess::SlaveMixMove()	{
...
double PartitionedGTRSBDPProfileProcess::MixMove(int nrep, int nallocrep, double epsilon, int nprofilerep)	{
...
double PartitionedGTRSBDPProfileProcess::IncrementalDPMove(int nrep, double epsilon)	{
...
double PartitionedGTRSBDPProfileProcess::GlobalIncrementalDPMove(int nrep, double epsilon)	{
...
void PartitionedGTRSBDPProfileProcess::SlaveIncrementalDPMove()	{
