...
void AAMutSelFinitePhyloProcess::SlaveUpdateParameters()	{
...
void AAMutSelFinitePhyloProcess::SlaveExecute(MESSAGE signal)	{
...
void AAMutSelFinitePhyloProcess::GlobalUpdateParameters() {
	// MPI2
...
void AAMutSelFinitePhyloProcess::ReadPB(int argc, char* argv[])	{
