...
void AAMutSelDPPhyloProcess::SlaveUpdateParameters()	{
...
void AAMutSelDPPhyloProcess::SlaveExecute(MESSAGE signal)	{
...
void AAMutSelDPPhyloProcess::GlobalUpdateParameters() {
	// MPI2
	...
	L1 = GetNmodeMax();
	L2 = GetDim();
	//nd = nbranch + nnucrr + nnucstat + L1*L2;
	nd = 2 + nbranch + nnucrr + + nnucstat + L1*L2 + GetDim() + 1;
