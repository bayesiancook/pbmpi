...
class SubstitutionProcess : public virtual RateProcess, public virtual ProfileProcess {
	...
	SubstitutionProcess() : condsitelogL(0), sitelogL(0), meansiterate(0), ratealloc(0), infprobcount(0), suboverflowcount(0), catch_errors(false), stone_index(-1), num_stones(0), sitemask_needs_updating(false) {}
