...
//-------------------------------------------------------------------------
//-------------------------------------------------------------------------
//	* PartitionedExpoConjugateGTRMixtureProfileProcess
//-------------------------------------------------------------------------
//-------------------------------------------------------------------------

void PartitionedExpoConjugateGTRMixtureProfileProcess::Create(int indim, PartitionScheme inscheme)	{
	PartitionedExpoConjugateGTRProfileProcess::Create(indim, inscheme);
	if (! profilesuffstatcount)	{
		PartitionedGTRMixtureProfileProcess::Create(indim, inscheme);
...
void PartitionedExpoConjugateGTRMixtureProfileProcess::Delete() {
	if (profilesuffstatcount)	{
		for (int i=0; i<GetNmodeMax(); i++)	{
...
void PartitionedExpoConjugateGTRMixtureProfileProcess::UpdateModeProfileSuffStat()	{
...
double PartitionedExpoConjugateGTRMixtureProfileProcess::ProfileSuffStatLogProb(int cat)	{
	double total = 0;
	for (int k=0; k<GetDim(); k++)	{
...
void PartitionedExpoConjugateGTRMixtureProfileProcess::SwapComponents(int cat1, int cat2)	{
...
double PartitionedExpoConjugateGTRMixtureProfileProcess::LogStatProb(int site, int cat)	{
...
double PartitionedExpoConjugateGTRMixtureProfileProcess::PoissonDiffLogSampling(int cat, int site)	{
